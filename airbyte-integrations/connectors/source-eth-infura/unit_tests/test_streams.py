...
import pytest
from source_eth_infura.source import EthInfuraStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(EthInfuraStream, "path", "v0/example_endpoint")
    mocker.patch.object(EthInfuraStream, "primary_key", "test_primary_key")
    mocker.patch.object(EthInfuraStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = EthInfuraStream()
